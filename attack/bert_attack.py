...
class BertAttack():
    ...
    def attack(self, net, texts, k=10, num_perturbation=1, threshold_pred_score=0.3, max_length=30, batch_size=32):
        ...
        origin_output = net.module.inference_text(text_inputs)
        if self.cls:
        ...
        for i, text in enumerate(texts):
            ...
            for top_index in list_of_index:
                ...
                replace_output = net.module.inference_text(replace_text_input)
                if self.cls:
    ...
    def get_important_scores(self, text, net, origin_embeds, batch_size, max_length):
        ...
        for i in range(0, len(masked_texts), batch_size):
            ...
            masked_output = net.module.inference_text(masked_text_input)
            if self.cls:
...
class BertAttackFusion():
    ...
    def attack(self, net, images, texts, k=10, num_perturbation=1, threshold_pred_score=0.3, max_length=30, batch_size=32):
        ...
        # original state
        origin_output = net.module.inference(images, text_inputs)
        if self.cls:
        ...
        for i, text in enumerate(texts):
            ...
            for top_index in list_of_index:
                ...
                replace_output = net.module.inference(images[i].repeat(replace_text_input.input_ids.size(0), 1, 1, 1),
                                               replace_text_input)
                if self.cls:
    ...
    def get_important_scores(self, image, text, net, origin_embed, batch_size, max_length):
        ...
        for i in range(0, len(masked_texts), batch_size):
            ...
            masked_output = net.module.inference(image_batch, masked_text_input)
            if self.cls:
