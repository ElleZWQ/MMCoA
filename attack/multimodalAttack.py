        ...
        if adv == 2 or adv == 3:
            ...
            with torch.no_grad():
                ...
                text_input = self.tokenizer(text_adv, padding='max_length', truncation=True, max_length=max_length,
                                            return_tensors="pt").to(device)
                text_adv_output = self.net.module.inference_text(text_input)
            ...
            with torch.no_grad():
                image_output = self.net.module.inference_image(self.image_normalize(images))
                if self.cls:
            ...
            for i in range(num_iters):
                ...
                image_adv_output = self.net.module.inference_image(image_adv)
                if self.cls:
